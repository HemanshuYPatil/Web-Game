...
const PURPLE = { r: 0x43, g: 0xa9, b: 0xcc };
const allColors = [BLUE, GREEN, PINK, ORANGE,PURPLE];
...
function makeRecursiveCubeModel({ recursionLevel, splitFn, color, scale=1 }) {
	...
	const maxComponent = getScaleAtLevel(recursionLevel) * (5 ** recursionLevel - 1);
...
handleClick($('.restart-btn'), () => restartgame());
